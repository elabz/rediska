    ...
    <>
      <div className="space-y-3">
        {watches.map((watch) => (
          <Card
            key={watch.id}
            className={`${!watch.is_active ? 'opacity-60' : ''} transition-colors hover:bg-muted/50`}
          >
            <CardContent className="p-4">
              <div className="flex items-start justify-between gap-4">
                {/* Watch Info - Clickable area */}
                <Link
                  href={`/settings/scout-watches/${watch.id}/history`}
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      <DropdownMenuItem asChild>
                        <Link href={`/settings/scout-watches/${watch.id}/history`}>
